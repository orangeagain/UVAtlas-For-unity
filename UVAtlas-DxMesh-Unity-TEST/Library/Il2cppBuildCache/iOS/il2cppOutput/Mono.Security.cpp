...
IL_0058:
	...
	}
	{
		...
		NullCheck(L_28);
		ASN1_Decode_mC4CF3CB2CC1DB454AA9C720BA79520956FB1F77B(__this, L_27, (&V_3), ((int32_t)((int32_t)(((RuntimeArray*)L_28)->max_length))), NULL);
	}
...
IL_0026:
		{
			...
			NullCheck(L_7);
			int32_t L_9;
			L_9 = VirtualFuncInvoker1< int32_t, RuntimeObject * >::Invoke(24 /* System.Int32 System.Collections.ArrayList::Add(System.Object) */, L_7, (RuntimeObject *)L_8);
			int32_t L_10 = V_3;
